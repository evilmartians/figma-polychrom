...
const retrieveSavedColorSpaceDisplayMode = (
	...
	void figma.clientStorage.getAsync(ClientStorageKeys.savedColorSpaceDisplayMode).then(callback);
};

const setNewColorSpaceDisplayMode = (mode: ColorSpaceDisplayModes): void => {
	void figma.clientStorage.setAsync(ClientStorageKeys.savedColorSpaceDisplayMode, mode);
};

const postColorSpaceDisplayModeMessage = (mode: ColorSpaceDisplayModes): void => {
